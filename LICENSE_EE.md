# The OpenFrame AI Enterprise License (the "Enterprise License")

Copyright (c) 2026-present OpenFrame AI.

With regard to the OpenFrame AI Software:

This software and associated documentation files (the "Software") may only be
used in production, if you (and any entity that you represent) hold a valid
OpenFrame AI Enterprise license corresponding to your usage. Subject to the
foregoing sentence, you are free to modify this Software and publish patches to
the Software. You agree that OpenFrame AI and/or its licensors (as applicable)
...
modified, displayed, distributed, or otherwise exploited with a valid OpenFrame
AI Enterprise license for the corresponding usage. Notwithstanding the
foregoing, you may copy and modify the Software for development and testing
purposes, without requiring a subscription. You agree that OpenFrame AI and/or
...
For all third party components incorporated into the OpenFrame AI Software,
